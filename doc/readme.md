...
Imagine you have a list of items in a structured data file (yaml, json, bibtex, etc.).
    ...
    For example, you might have a file that includes a list of your talks, and you want to select some of the items, sort them, and format them neatly for your website.
...
The `select` attribute takes a boolean expression involving names of Python classes -- 'selector' classes.
    You can create these classes by subclassing `Selector` from module `pandocinject` and changing the result to suit your needs.
...
The `format` attribute takes the name of a Python class -- the 'formatter' class.
    You can create a formatter class by subclassing `Formatter` from module `pandocinject` and tweaking the result to suit your needs.
...
Objects from this class create pandoc filters.
    You need to instantiate one of these to create a pandoc filter.
